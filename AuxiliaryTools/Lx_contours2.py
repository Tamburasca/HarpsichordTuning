...
# exact to b=3.e-4
FOUNDS = [np.float64(415.0), np.float64(830.3733040342664),
          np.float64(1246.4926571451213), np.float64(1663.7296899002804),
          np.float64(2082.454369881657), np.float64(2503.034463514703),
          np.float64(2925.8350114703494), np.float64(3351.217820693767),
          np.float64(3779.540975899514), np.float64(4211.158373125729),
          np.float64(4646.419277666281), np.float64(5085.667908404718),
          np.float64(5529.243050263511), np.float64(5977.477696162285),
          np.float64(6430.698719555558), np.float64(6889.226578299327),
          np.float64(7353.37505028208), np.float64(7823.451000954164),
          np.float64(8299.754182603996), np.float64(8782.57706496387)]
